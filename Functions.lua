...
function Main:isKeyPressed(keyName)
...
function Main:GetName(id, Main_Table)
    ...
    elseif id == 2 and Main_Table.Elements.Allow_Standing:get() then

    return 'Standing'

    elseif id == 3 and Main_Table.Elements.Allow_Walking:get() then

    return 'Walking'

    elseif id == 4 and Main_Table.Elements.Allow_Running:get() then

    return 'Running'

    elseif id == 5 and Main_Table.Elements.Allow_Crouching:get() then

    return 'Crouching'

    elseif id == 6 and Main_Table.Elements.Allow_In_Air:get() then
